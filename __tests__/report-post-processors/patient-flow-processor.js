...
// var patientFlowSamples = require('../__mocks__/patient-flow-sample');
...
//     expect(patientFlowSamples).toBeDefined();
//   });

//   it('should inject patient flow module', function () {
//     expect(patientFlowProcessor).toBeDefined();
//   });
...
//     expect(groupedResults[0].time_to_complete_visit !== undefined).toBeTruthy();
//   });

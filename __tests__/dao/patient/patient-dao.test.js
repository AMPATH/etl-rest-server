...
//         expect(p).toHaveProperty('person');
//         expect(p).toHaveProperty('obsDatetime');
//         expect(p).toHaveProperty('value');
//         expect(p).toEqual(expectedOutput);
//         done();
//       });
//     });
...
//         expect(p).toHaveProperty('person');
//         expect(p).toHaveProperty('obsDatetime');
//         expect(p).toHaveProperty('groupMembers');
//         expect(p.groupMembers instanceof Array).toBeTruthy();

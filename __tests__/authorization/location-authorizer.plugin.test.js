...
// // Internal modules
// const libpath = '../../authorization';
// const Plugin = require(libpath + '/location-authorizer.plugin.js');
...
//   it('does not interfere with handlers throwing exceptions', (done) => {
...
//   it('makes sure that openmrsLocationAuthorizer can be enabled only for secured routes', (done) => {
...
//   it('should allow openmrsLocationAuthorizer for routes secured in the route config', (done) => {
//     var server = new Hapi.Server(0);
//     server.connection();
...
//   it('should allow openmrsLocationAuthorizer for routes secured globally with authentication', (done) => {
//     var server = new Hapi.Server(0);
//     server.connection();
//     server.auth.scheme('custom', internals.authSchema);
//     server.auth.strategy('default', 'custom', false, {});
...
//   it('ignores routes without openmrsLocationAuthorizer instructions', (done) => {
//     var server = new Hapi.Server();
//     server.connection();
//     server.route({
//       method: 'GET',
...
//         expect(res.payload).toEqual('TEST');
//         done();
//       });
//     });
//   });

//   it('Validates the openmrsLocationAuthorizer plugin options are optional', (done) => {
//     var server = new Hapi.Server(0);
//     server.connection();
//     server.auth.scheme('custom', internals.authSchema);

...
//     expect(indicatorProcessor).toBeDefined();
//   });

//   it('should have required methods defined', function () {
//     expect(indicatorProcessor.disaggregateDynamicIndicators).toBeDefined();
//     expect(indicatorProcessor.disaggregateFixedIndicators).toBeDefined();
//     expect(indicatorProcessor.replaceIndicatorParam).toBeDefined();
//   });

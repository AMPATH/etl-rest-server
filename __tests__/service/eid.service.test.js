...
//       // expect(getResourceStub.calledWithExactly('some host', 'some api key')).toBeTruthy();
//       // expect(getCd4ResourceStub.calledWithExactly('some host', 'some api key')).toBeTruthy();
//     });
...
//           expect(getResourceStub.calledWithExactly('host', 'key')).toBeTruthy();

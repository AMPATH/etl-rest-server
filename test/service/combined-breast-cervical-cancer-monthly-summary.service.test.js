...
describe('CombinedBreastCervicalCancerMonthlySummary: ', () => {
  const service = new CombinedBreastCervicalCancerMonthlySummary();
        ...
        results: [
          {
            ...
            normal_findings: 14,
            procedures_done: 0,
            total_breast_and_cervical_screened: 14
          }
        ]
      }
    };
  ...
  test('fetches and returns a patient list', async () => {
    testParams = {
      requestParams: {
        indicators: 'total_breast_and_cervical_screened',
        endDate: '2021-01-31',
        startDate: '2021-01-01',
        period: 'monthly',
        startAge: 0,

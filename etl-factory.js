...
reportList.push.apply(reportList, require('./reports/hiv-daily-visits-appointment.report.json'));
reportList.push.apply(reportList, require('./reports/program-monthly-clinic-schedule-report.json'));

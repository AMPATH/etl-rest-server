...
function _getProviders(encModelArray) {
  ...
  _.each(encModelArray, function(encModel) {
    console.log('Provider===>', encModel.provider || '');
...
var self = function() {
  return {
    ...
    getHivSummary: function getHivSummary(request) {
      console.log('Dao=========>', dao);
      // dao.getPatientHivSummary(request, function (result) {
      //   console.log(result)
      // });
      return new Promise(function(resolve, reject) {
        var options = {
          uri: 'http://localhost:8002/etl/patient/' + request.params.uuid + '/hiv-summary',
          qs: {
    ...
    getVitals: function getVitals(request, callback) {
      return new Promise(function(resolve, reject) {
        var options = {
          uri: 'http://localhost:8002/etl/patient/' + request.params.uuid + '/vitals',
          qs: {
            startIndex: request.query.startIndex,
            limit: request.query.limit
          },
    ...
    getPatientEncounters: function getPatientEncounters(request, callback) {
      return new Promise(function(resolve, reject) {
        ...
        var options = {
          uri: 'https://test1.ampath.or.ke:8443/amrs/ws/rest/v1/encounter',
          qs: {
            v: _customDefaultRep,

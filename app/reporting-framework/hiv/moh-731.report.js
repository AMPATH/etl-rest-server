...
export class Moh731Report extends MultiDatasetPatientlistReport {
  constructor(reportName, params) {
    ...
    params.hivSummaryDataSource =
      '(SELECT fhsvb.person_id, fhsvb.vl_1, fhsvb.vl_1_date, fhsvb.weight, fhsvb.height, fhsvb.cur_who_stage as stage, fhsvb.cd4_1, fhsvb.cd4_1_date FROM etl.flat_hiv_summary_v15b fhsvb where fhsvb.is_clinical_encounter = 1 and fhsvb.next_clinical_datetime_hiv is null)';

...
const caseSurveillanceSections = require('../../app/reporting-framework/json-reports/case-surveillance/summaries/case-surveillance-indicator.json');
const caseSurveillancePatientListCols = require('../../app/reporting-framework/json-reports/tx-reports/tx-ml/tx-ml-report-patient-list-cols.json');

const etlHelpers = require('../../etl-helpers.js');

export class CaseSurveillanceService extends MultiDatasetPatientlistReport {
          ...
          super.generateReport(additionalParams).then((results) => {
            if (additionalParams && additionalParams.type === 'patient-list') {
              ...
              resolve({
                ...
                result: finalResult,
                sectionDefinitions: caseSurveillanceSections,
    ...
    return new Promise((resolve, reject) => {
      super
        ...
        .then((results) => {
          ...
          results['patientListCols'] = caseSurveillancePatientListCols;

...
const heiregisterSections = require('../../../app/reporting-framework/registers/hei-register-framework.json');

export class HeiRegisterService extends MultiDatasetPatientlistReport {
  ...
  getAggregateReport(reportParams) {
    ...
    return new Promise((resolve, reject) => {
      super
        ...
        .catch((error) => {
          console.error('hei register generation error: ', error);
          reject(error);
        });
    });
  }

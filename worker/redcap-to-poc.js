...
//limits the number of requests going outdataentrystats
...
let App = {
  ...
  testData: [{
    ...
    },
    {
      ...
      principal_national_id_number:'13203455',
      number_of_dpts: '',
      spouse_surname: '',
      spouse_first_name: '',
      spouse_date_of_birth: '',
    ...
    },
    {
      ...
      principal_national_id_number:'10033301',
      number_of_dpts: '',
      spouse_surname: '',
      spouse_first_name: '',
      spouse_date_of_birth: '',
    ...
    },
    {
      ...
      principal_national_id_number:'20347265',
      number_of_dpts: '3',
    ...
    },
    {
      ...
      principal_national_id_number:'1237589',
      number_of_dpts: '1',
  ...
  identifier_type2: "9cae9c8a-2821-4aa7-8064-30508e9f62ec",
        ...
        if (!err && httpResponse.statusCode === 200) {
          ...
          _.each(data, function(value) {
            ...
            if (numberOfDependents === '0' || numberOfDependents === '') {
                ...
                patient_data.principal_national_id_number = value.principal_national_id_number,
                ...
                patient_data.spouse_national_id_number = value.spouse_national_id_number
  ...
  process: function() {
    ...
    console.log('********************************************************');
    App.checkIfPatientExist(App.testData).then((data) => {

      //App.createPrincipal(existingPatients);
      App.createPrincipal(data);
  ...
  createPrincipal: function(principal) {
    let sortedData = [];
    principal.map((p) => {
      let p_principal = App.createPatientRequest(p.principal_surname, p.principal_first_name, p.principal_gender, p.principal_date_of_birth,p.principal_national_id_number);
      sortedData.push(p_principal);
      if (p.spouse_surname) {
        let s_spouse = App.createPatientRequest(p.spouse_surname, p.spouse_first_name, p.principal_gender, p.spouse_date_of_birth,p.spouse_national_id_number);
  ...
  createPatientRequest: function(surname, familyname, gender, dob,zuriId) {
    ...
    if(zuriId){
      payload = {
        ...
        "identifiers": [{
          ...
          "identifierType": App.identifier_type2,
          "identifier": zuriId,
          "location": App.default_location,
          "preferred": true
        }]
  ...
  logPatients: function (family_name, identifier,surname) {
    var sql = "INSERT INTO etl.redcap_to_poc_logs(family_name, identifier, surname)" +
      " VALUES('" + family_name + "','" + identifier + "','" + surname + "' )";

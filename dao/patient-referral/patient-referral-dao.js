      ...
      try{
        resolveEnrollmentUuidsToIds(newPatientReferral).
            then(function (newPateintReferral) {
                console.log('--------------newPateintReferral-----------------', newPateintReferral);
            ...
            .then(function (encounterId) {
                ...
                getPatientProgramId(referralPayload.patientProgram)
                    .then(function (patientProgramId) {
                        ...
                        getProgramId(referralPayload.patientProgramIdCurrent)
                        .then(function(programId){
                          referralPayload.patientProgramIdCurrent = programId;
                          getProgramId(referralPayload.patientProgramIdPrevious)
                          .then(function(programId1){
                            referralPayload.patientProgramIdPrevious = programId1;

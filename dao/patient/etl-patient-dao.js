  ...
  function getPatientLabData(request, callback) {
    ...
    db.queryServer_test(queryParts, function (result) {
      _.each(result.result, function (row) {
        ...
        row.cd4_lateral_flow = helpers.getConceptName(row.cd4_lateral_flow);
